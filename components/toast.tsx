...
export function Toast({
  ...
  return (
    <div
      ...
      className={`fixed right-4 top-4 z-[120] w-[calc(100%-2rem)] max-w-sm overflow-hidden border bg-white shadow-[0_18px_55px_rgba(0,0,0,0.16)] sm:right-6 sm:top-6 ${style.shell} ${closing ? "toast-out" : "toast-in"}`}
    >
