	...
	return (
		<main>
			...
			<section className="container-page py-24 sm:py-32">
				...
				{albums.length ? (
					<div className="grid gap-x-5 gap-y-14 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
			...
			<section
				id="about"
				className="bg-[#dedbd2] py-24 sm:py-36"
			>
				<div className="container-page grid gap-12 lg:grid-cols-2 lg:items-center">
					...
					<div className="max-w-xl lg:pl-12">
						...
						<p className="mt-8 font-serif whitespace-pre-line text-lg leading-7 text-neutral-600 text-justify">
							{settings.about_description}
						</p>
						<div className="flex justify-center">
							<Link
								href="/book"
								className="button-light mt-9"
							>
								Let’s work together
							</Link>
						</div>
